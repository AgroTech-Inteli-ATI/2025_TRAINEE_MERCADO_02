...
const config = {
  ...
  baseUrl: '/2025_TRAINEE_MERCADO_02/',

  organizationName: 'InteliProjects', // Atualize conforme sua organização
  projectName: '2025_TRAINEE_MERCADO_02',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/agrotechinteli/2025_TRAINEE_MERCADO_02', // Atualize para o URL correto do seu repositório
            label: 'GitHub',
            position: 'right',
          },
        ],
